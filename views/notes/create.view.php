...
<main>
    <div class="mx-auto max-w-7xl py-6 px-2 sm:px-6 lg:px-8">
        ...
        <div class="grid place-items-center max-w-2xl mx-auto">
            <form class="min-w-full space-y-10 border border-gray-900/10 p-4" method="POST" action="/notes">
                <div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <textarea id="note" name="note" rows="6" required
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?= $_POST['note'] ?? '' ?></textarea>
                    </div>
                ...
                <div class="mt-6 flex items-center justify-end gap-x-4">
                    <button type="button"
                        class="text-sm py-2 px-3 font-semibold text-gray-900 hover:bg-gray-300 bg-gray-200 rounded-md">Cancel</button>
                    <button type="submit"
